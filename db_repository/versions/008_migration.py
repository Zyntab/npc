...
character = Table('character', post_meta,
    ...
    Column('move_carry', String(length=400)),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['character'].columns['campaign'].create()
    post_meta.tables['character'].columns['notes'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['character'].columns['campaign'].drop()
    post_meta.tables['character'].columns['notes'].drop()
